...
func (x *Response) GetDelay() string {
	if x != nil {
		return x.Delay
	}
	return ""
...
var file_infrabin_proto_rawDesc = []byte{
	...
	0x12, 0x14, 0x0a, 0x05, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x6f, 0x64, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0x39, 0x0a, 0x08, 0x49, 0x6e, 0x66, 0x72, 0x61,
	0x62, 0x69, 0x6e, 0x12, 0x2d, 0x0a, 0x04, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x0f, 0x2e, 0x69, 0x6e,
	0x66, 0x72, 0x61, 0x62, 0x69, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x12, 0x2e, 0x69,
	0x6e, 0x66, 0x72, 0x61, 0x62, 0x69, 0x6e, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
...
var file_infrabin_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_infrabin_proto_goTypes = []interface{}{
	...
	nil,                  // 3: infrabin.Response.HeadersEntry
	nil,                  // 4: infrabin.Response.EnvEntry
}
var file_infrabin_proto_depIdxs = []int32{
	2, // 0: infrabin.Response.kubernetes:type_name -> infrabin.KubeResponse
	3, // 1: infrabin.Response.headers:type_name -> infrabin.Response.HeadersEntry
	4, // 2: infrabin.Response.env:type_name -> infrabin.Response.EnvEntry
	0, // 3: infrabin.Infrabin.Root:input_type -> infrabin.Empty
	1, // 4: infrabin.Infrabin.Root:output_type -> infrabin.Response
